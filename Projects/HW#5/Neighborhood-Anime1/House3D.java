 ...
 * Date of Submission -- December 2, 2019
 * Language Used ------- Java & OpenGL
 * Class Imported ------ Camera from Camera.java (written by Dr. Eck)
 * --------------------- ObjectsToDraw.java (written by Cecilia S.)
 * Description --------- Use JOGL to draw a 3D architectural scene
 * Warning ------------- It takes several minutes to render the graphics. 
--------------------------------------------------------------------------- */
