 ...
 * Assignment ---------- 3D House with Windoes (Exam#2)
 ...
 * Features Added ------ Can use key board to move the camera lookat point
...
// HouseWindow class 
// ----------------------------------------------------------------------------
public class HouseWindowKeys extends GLJPanel implements GLEventListener, KeyListener {
    public static void main(String[] args) {
        JFrame window = new JFrame("House with windows");
        HouseWindowKeys panel = new HouseWindowKeys();
        ...
        System.out.println("The arrow keys UP & DOWN can move on y-axis.");
        System.out.println("The arrow keys LEFT & RIGHT can move on x-axis.");
        System.out.println("The keys W & S can move on z-axis.");
        System.out.println("The SPACE key can move back to original state.");
    ...
    public void init(GLAutoDrawable graphics) {
        ...
        cy = 8; 
        cz = -50; 
        camera.lookAt(cx,cy,cz, 0,0,1, 0,1,0);
